...
namespace AdventOfCode.Solutions.Year2024.Day6;

internal class Day6 : IProblemSolution
{
    public void Run()
    {
    ...
    private static int PartOne(char[][] input, int guardX, int guardY) => Go(input, guardX, guardY);

    private static int PartTwo(char[][] grid, int guardX, int guardY)
    {
        int count = 0;
    ...
    private static int Go(char[][] grid, int guardX, int guardY)
    {
